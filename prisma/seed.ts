...
async function main() {
  ...
  const turfData = [
    ...
    {
      id: 3,
      name: 'Ahmedabad Racquet Academy',
      city: 'Ahmedabad',
      ...
      description:
        'Modern courts with comfortable seating and a coaching team on standby. Perfect for multiple sports and social matches.',
    ...
    {
      id: 8,
      name: 'Sama Indoor Sports Complex',
      city: 'Vadodara',
      location: 'Sama',
      sport: 'Multi-sport',
      price: 1300,
